...
def build_and_save_indices(chunks: list):
    """Build and save both FAISS and BM25 indices"""
    if not chunks:
        logger.error("No document chunks to process!")
        return
    ...
    # Build FAISS index
    logger.info("Generating FAISS embeddings...")
    embeddings = HuggingFaceEmbeddings(
        model_name="BAAI/bge-small-en-v1.5",
    ...
    bm25_retriever = BM25Retriever.from_documents(
        documents=chunks,
        k=5  # Number of documents to return by default
    )
